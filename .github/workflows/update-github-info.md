...
description: Keep the GitHub Info page current with useful, sourced updates from the GitHub Blog and Changelog.
on:
  schedule: daily
  workflow_dispatch:
permissions:
...
5. Update `site/content/github-info.md` with the selected updates. Mention the source for every update from the GitHub Blog or GitHub Changelog.
